...
import torch
from transformers import AutoTokenizer, GPT2ForSequenceClassification, pipeline
import time
import numpy as np
...
class_tokenizer = AutoTokenizer.from_pretrained("../pretrain_model/gpt-2")
class_model = GPT2ForSequenceClassification.from_pretrained("../pretrain_model/style_classifier_model")
